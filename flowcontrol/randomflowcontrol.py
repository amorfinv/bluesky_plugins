...
def replan(acid_to_replan):
    ...
    for acid, acidx in acid_to_replan:
        ...
        # here check if we have reached the replan limit and break if we have reached
        # limit
        if succesful_replans/bs.traf.ntraf > bs.traf.flowcontrol.replan_limit:
            break
